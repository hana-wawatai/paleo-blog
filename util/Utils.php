...
final class Utils {
    ...
    /**
     * Get {@link Blog} by the identifier 'id' found in the URL.
     * @return Blog {@link Blog} instance
    ...
    public static function getObjByGetId($dao) {
        ...
        try {
            ...
            throw new NotFoundException('No Blog identifier provided.');
        }
        if (!is_numeric($id)) {
            throw new NotFoundException('Invalid Blog identifier provided.');
        }
//        $dao = new BlogDao();
        $obj = $dao->findById($id);
        if ($obj === null) {
            throw new NotFoundException('Unknown Blog identifier provided.');
        }
        return $obj;
    }
