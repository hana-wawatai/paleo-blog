...
final class Index {
    ...
    public function loadClass($name) {
        $classes = array(
            ...
            'BlogValidator' => '../validation/BlogValidator.php',
    ...
    private function checkPage($page) {
        if (!preg_match('/^[a-z0-9-]+$/i', $page)) {
            // Blog log attempt, redirect attacker, ...
